# Guia de Melhores Práticas: Jogo da Velha & Deploy GitHub

Este documento formaliza as diretrizes para o desenvolvimento do Jogo da Velha (Tic-Tac-Toe) com foco em versionamento e deploy.
